...
@interface Turntable (SWIFT_EXTENSION(Vinyl))
- (void)loadVinyl:(NSString * _Nonnull)vinylName bundle:(NSBundle * _Nonnull)bundle;
- (void)loadCassette:(NSString * _Nonnull)cassetteName bundle:(NSBundle * _Nonnull)bundle;
@end
