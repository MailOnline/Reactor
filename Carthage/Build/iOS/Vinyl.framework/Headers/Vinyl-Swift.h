...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Vinyl",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface Turntable (SWIFT_EXTENSION(Vinyl))
- (void)loadWithVinyl:(NSString * _Nonnull)vinylName bundle:(NSBundle * _Nonnull)bundle;
- (void)loadWithCassette:(NSString * _Nonnull)cassetteName bundle:(NSBundle * _Nonnull)bundle;
@end
...
- (NSURLSessionUploadTask * _Nonnull)uploadTaskWithRequest:(NSURLRequest * _Nonnull)request fromData:(NSData * _Nullable)bodyData completionHandler:(void (^ _Nonnull)(NSData * _Nullable, NSURLResponse * _Nullable, NSError * _Nullable))completionHandler SWIFT_WARN_UNUSED_RESULT;
- (void)invalidateAndCancel;
@end


SWIFT_CLASS("_TtC5Vinyl18URLSessionDataTask")
